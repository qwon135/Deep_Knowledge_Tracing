...
def custom_train_test_split(df, ratio=0.9, split=True, seed=42):
    ...
    # user_ids = pd.read_csv('/opt/ml/input/data/test_data.csv').userID.unique()


    train = df[df['userID'].isin(user_ids) == True]
